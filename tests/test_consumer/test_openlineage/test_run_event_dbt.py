...
def test_run_event_dbt_job_start():
    json = {
        "producer": "https://github.com/OpenLineage/OpenLineage/tree/1.34.0/integration/dbt",
        ...
        "job": {
            ...
            "facets": {
                "jobType": {
                    "_producer": "https://github.com/OpenLineage/OpenLineage/tree/1.34.0/integration/dbt",
...
def test_run_event_dbt_job_start_before_openlineage_1_34():
        ...
        outputs=[
            OpenLineageOutputDataset(
                ...
                outputFacets=OpenLineageOutputDatasetFacets(
                    outputStatistics=OpenLineageOutputStatisticsOutputDatasetFacet(rowCount=2),
                ),
            ),
        ],
    )
...
def test_run_event_dbt_model_start_openlineage_1_33():
    json = {
