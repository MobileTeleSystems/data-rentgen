from data_rentgen.consumer.extractors import extract_job_location
from data_rentgen.consumer.openlineage.job import OpenLineageJob
from data_rentgen.dto import LocationDTO


def test_extractors_extract_job_location_spark_yarn():
...
def test_extractors_extract_job_location_airflow():
    job = OpenLineageJob(namespace="airflow://airflow-host:8081", name="myjob")
