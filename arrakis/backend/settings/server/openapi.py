...
class SwaggerSettings(BaseModel):
    ...
    .. code-block:: bash
        ...
        ARRAKIS__SERVER__OPENAPI__SWAGGER__JS_URL=/static/swagger/swagger-ui-bundle.js
...
class LogoSettings(BaseModel):
    ...
    .. code-block:: bash
        ...
        ARRAKIS__SERVER__OPENAPI__LOGO__URL=/static/logo.svg
        ARRAKIS__SERVER__OPENAPI__LOGO__BACKGROUND_COLOR=ffffff
        ARRAKIS__SERVER__OPENAPI__LOGO__ALT_TEXT=Arrakis logo
        ARRAKIS__SERVER__OPENAPI__LOGO__HREF=http://mycompany.domain.com
    """
...
class FaviconSettings(BaseModel):
    ...
    .. code-block:: bash
        ...
        ARRAKIS__SERVER__OPENAPI__FAVICON__URL=/static/icon.svg
    """
