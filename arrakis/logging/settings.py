...
class LoggingSettings(BaseSettings):
    """Arrakis backend logging Settings.
    ...
    .. code-block:: bash
        ...
        ARRAKIS__LOGGING__SETUP=True
        ARRAKIS__LOGGING__CUSTOM_CONFIG_PATH=/some/logging.yml

    Setup logging in some other way, e.g. using `uvicorn args <https://www.uvicorn.org/settings/#logging>`_:

    .. code-block:: bash

        $ export ARRAKIS__LOGGING__SETUP=False
        $ python -m arrakis.server --log-level debug
    """
    ...
    preset: Literal["json", "plain", "colored"] = Field(
        ...
        description=textwrap.dedent(
            ...
            There are few logging presets bundled to ``data-arrakis[server]`` package:
            ...
            .. dropdown:: ``colored`` preset
                ...
                .. literalinclude:: ../../../../arrakis/logging/presets/colored.yml
            ...
            .. dropdown:: ``json`` preset
                ...
                .. literalinclude:: ../../../../arrakis/logging/presets/json.yml
            """,
        ),
    )
    ...
    model_config = SettingsConfigDict(env_prefix="ARRAKIS__LOGGING__", env_nested_delimiter="__", extra="forbid")
