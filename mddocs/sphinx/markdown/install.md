...
* Browse frontend at [http://localhost:3000](http://localhost:3000)
* Open REST API Swagger doc at [http://localhost:8000/docs](http://localhost:8000/docs)
